...
dbClient = InfluxDBClient(host='192.168.2.35', port=8086, username='influx_woo', password='1234', database='db_riatech')

def on_connect(client, userdata, flags, rc):
    print("Connect with result code " + str(rc) )
    client.subscribe("Sensors/MyOffice/#")				# Sensors/MyOffice/Indoor/Temp
